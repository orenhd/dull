...
**מסמך API חדש:** `docs/API_CONTRACT.md` - חוזה ה-API החי (endpoints, auth/cookies, CORS, מבני תגובה), נכתב ישירות מהקוד ב-`backend/src/routes/`. קרא/י אותו לפני כל עבודת אינטגרציה מול ה-backend.
